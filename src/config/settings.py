...
DATA_DIR = Path('data_new')  # Base directory for storing crawl data
...
# Browser settings
BROWSER_SETTINGS = {
    # "viewport": {"width": 1512, "height": 775},
...
# Worker settings
WORKER_ID_PREFIX = "mbp"  # Prefix for worker IDs
DEFAULT_WORKER_ID = f"{WORKER_ID_PREFIX}"  # Default worker ID
CONCURRENT_DOMAINS = 5  # Number of domains to process concurrently
...
# # Redis connection parameters - Use environment variables for production
# REDIS_CONFIG = {
...
# SECURITY NOTE: Use environment variables for sensitive credentials in production
MONGODB_URI = os.getenv('MONGODB_URI', 'mongodb://localhost:27017')  # Default to localhost for development
MONGODB_DB_NAME = os.getenv('MONGODB_DB_NAME', 'web_crawler')
MONGODB_DOMAINS_COLLECTION = "domains"
MONGODB_URLS_COLLECTION = "urls"
